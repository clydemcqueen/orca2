...
void generateTargetPose(const rclcpp::Time &t, tf2::Transform &transform)
{
  static rclcpp::Time g_start = t;

  const double period = 60;
  const double radius = 0.25;

  rclcpp::Duration d = t - g_start;
  double elapsed_time = d.nanoseconds() / 1000000.0;
