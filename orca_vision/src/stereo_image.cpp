...
bool Image::initialize(const sensor_msgs::msg::Image::SharedPtr image)
{
...
bool StereoImage::initialize(
  ...
  const sensor_msgs::msg::Image::SharedPtr left_image,
  ...
  const cv::DescriptorMatcher &matcher)
{
  ...
  if (debug_)
  {
    ...
    RCLCPP_DEBUG(logger_, "%d good matches, median epipolar error=%g, median disparity=%g, median Z=%g, median match distance %g",
