...
public:
  ...
  // Initialize
  bool initialize(const sensor_msgs::msg::Image::SharedPtr image);
...
public:
  ...
  StereoImage(rclcpp::Logger logger, bool debug=false):
    logger_{logger},
    odom_to_left_camera_{tf2::Matrix3x3::getIdentity(), tf2::Vector3()},
    debug_{debug}
  {}
