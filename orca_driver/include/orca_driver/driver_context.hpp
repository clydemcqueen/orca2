...
#define DRIVER_NODE_ALL_PARAMS \
  ...
  \
  CXT_MACRO_MEMBER(thruster_1_channel, int, 0)                    /* PWM thruster 1 channel */ \
  CXT_MACRO_MEMBER(thruster_2_channel, int, 1)                    /* PWM thruster 2 channel */ \
  CXT_MACRO_MEMBER(thruster_3_channel, int, 2)                    /* PWM thruster 3 channel */ \
  CXT_MACRO_MEMBER(thruster_4_channel, int, 3)                    /* PWM thruster 4 channel */ \
  CXT_MACRO_MEMBER(thruster_5_channel, int, 4)                    /* PWM thruster 5 channel */ \
  CXT_MACRO_MEMBER(thruster_6_channel, int, 5)                    /* PWM thruster 6 channel */ \
  ...
  CXT_MACRO_MEMBER(thruster_6_reverse, bool, false)               /* PWM thruster 6 reverse */ \
  \
